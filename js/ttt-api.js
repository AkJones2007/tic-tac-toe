...
$(function() {
  ...
  $('#login').on('submit', function(e) {
    ...
    var cb = function cb(error, data) {
      if (error) {
        callback(error);
        $('.login-container').html('<h3>SORRY, SOMETHING WENT WRONG :(</h3><h3>PLESE TRY AGAIN LATER</h3>');
        return;
      }
      callback(null, data);
      ...
      // Function to execute if login is successful
      $('.login-container').html('<h3>LOGIN SUCCESSFUL! :D</h3>')
      setTimeout(function() {
